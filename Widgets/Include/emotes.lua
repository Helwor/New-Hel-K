WG.emotes = {
	...
	-- Hearts
	heart = '❤️',		-- U+2764 - Red heart
	heart2 = '♡',		-- U+2661 - White heart
	heart3 = '♥',		-- U+2665 - Black heart
	heart4 = '💔',
	...
	-- Nature and animals
	sun = '☀️',			-- U+2600 - Sun
	cloud = '☁️',		-- U+2601 - Cloud
	umbrella = '☂️',		-- U+2602 - Umbrella
	snowflake = '❄️',	-- U+2744 - Snowflake
	cat = '😺',			-- U+1F63A - Smiling cat
	demon = '👿',
	...
	exclam = '❗',		-- U+2757 - Exclamation mark
	
	-- Time and dates
	clock = '🕐',		-- U+1F550 - One o'clock
	calendar = '📅',		-- U+1F4C5 - Calendar
	hourglass = '⏳',	-- U+23F3 - Hourglass
	
	-- Vehicles
	car = '🚗',			-- U+1F697 - Car
	plane = '✈️',		-- U+2708 - Airplane
	...
	-- Sports
	soccer = '⚽',		-- U+26BD - Soccer ball
	basketball = '🏀',	-- U+1F3C0 - Basketball
	tennis = '🎾',		-- U+1F3BE - Tennis ball
	...
	-- kawaiiface.net -- much much more there
	kangry		= 'Ծ_Ծ',
	kangry2		= 'ヽ༼ ಠ益ಠ ༽ﾉ',
	kangry3		= '(`д´)',
	klookaway	= '◔_◔',
	...
	kcrazy		= '(☉ε ⊙ﾉ)ﾉ',
	klenny		= '( ͡° ͜ʖ ͡°)',
	klenny2		= '( ͡° ͜ʖ ( ͡° ͜ʖ ( ͡° ͜ʖ ( ͡° ͜ʖ ͡°) ͜ʖ ͡°)ʖ ͡°)ʖ ͡°)',
	klenny3		= '༼ つ ͠° ͟ ͟ʖ ͡° ༽つ',
	kouch		= '☆⌒(> _ <)',
	kouch2		= '.( ̵˃﹏˂̵ )',
	kparty		= 'ヽ(⌐■_■)ノ♪♬',
	kparty2		= 'ヾ(-_- )ゞ',
