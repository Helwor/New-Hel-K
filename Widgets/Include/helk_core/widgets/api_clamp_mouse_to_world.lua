...
do
	...
	local function OldMethod(mx,my, throughWater, margin, offsetHeight)
	...
	local function NewMethod(mx, my, throughWater) -- WORKS PERFECT
...
function widget:DrawWorld()
	if debugMe.state then
		...
		if pos then
			gl.Color(1,1,0,1)
			debugMe:draw(unpack(pos))
		end
		if pos2 then
			gl.Color(1,1,1,1)
			debugMe:draw(unpack(pos2))
		end
